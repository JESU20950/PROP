...
public class Machine2 extends Player{
            ...
            if (turn == super.color) {
                ...
                for (int i = 0; i < pieces.size(); ++i) {
                    ...
                    for (int j = 0; j < movement.size(); ++j) {
                        ...
                        int value = move_piece_machine(aux, depth-1, n, !turn, result, alpha, beta);
                        if (value > alpha) alpha = value;
                        else if (value > beta) return beta;
                ...
                for (int i = 0; i < pieces.size(); ++i) {
                    ...
                    for (int j = 0; j < movement.size(); ++j) {
                        ...
                        else if (value < alpha) return alpha;
                        best = min(value, best);
                    }
                }
                return best;
    ...
    public Cell[] move_piece(Game g) {
        ...
        //System.exit(0);
        int num = move_piece_machine(g.getTable(), min(n, 2), min(n, 2), g.getPlayer_who_plays(), c, -10000, 10000);
